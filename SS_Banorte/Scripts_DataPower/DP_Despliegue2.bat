...
REM cambiar valor del dominio
D:\OpenMake\DATAPOWER\curl\bin\curl.exe --cookie D:\OpenMake\DATAPOWER\session.txt http://15.128.18.84:8081/dmadminweb/API/setvar/application/%ESTADO%%%3B%VER%?name=dominio^&value=%DOMINIO%

REM cambiar valor del dominio
D:\OpenMake\DATAPOWER\curl\bin\curl.exe --cookie D:\OpenMake\DATAPOWER\session.txt http://15.128.18.84:8081/dmadminweb/API/setvar/application/%ESTADO%%%3B%VER%?name=proyecto^&value=%PROYECTO%
