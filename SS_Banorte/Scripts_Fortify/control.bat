...
hexecp -prg perl -ma -args "C:\Harvest-FF\RTC\Scripts\scan.pl" %TARGET_DIR%\%COMPONENTE%\%PROYECTO% -syn -m 15.128.19.108 -er D:\Fortify\Scripts\agente.dfo -rport 1576
