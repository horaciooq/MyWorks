...
public class selectfile extends JFrame {
   ...
   private void initComponents() {
        ...
        panelista = new JScrollPane();
        files = new JList();
        
        /*CReamos el panel con la lista*/
        panelista.setBounds(30,460,340,80);
        panelista.setViewportView(files);
		...
		jtfRutaEntrada.addActionListener(controlaEventos);
    }
