...
public class AlmBugTrackerPlugin extends AbstractBatchBugTrackerPlugin {
    ...
    private static final String CATEGORIA_FIELD_NAME = "user-09";
...
private GetMethod getReleases(final String domainName, final String projectName, UserAuthenticationStore credentials, HttpClient client) {
        ...
        try {
            ...
            query = new GetMethod(almUrlPrefix
                    + "/qcbin/rest/domains/" + domainName + "/projects/"
                    + projectName + "/releases?page-size=400" );
            query.addRequestHeader("Accept", "application/xml");
            return query;
...
private GetMethod getFolders(final String domainName, final String projectName, UserAuthenticationStore credentials, HttpClient client) {
    ...
    try {
        ...
        query = new GetMethod(almUrlPrefix
                + "/qcbin/rest/domains/" + domainName + "/projects/"
                + projectName + "/release-folders?page-size=400" );
        query.addRequestHeader("Accept", "application/xml");
        return query;
    } catch (Exception urie) {
        throw new RuntimeException(urie);
...
private GetMethod getCycles(final String domainName, final String projectName, UserAuthenticationStore credentials, HttpClient client) {
    ...
    private String constructDefectXmlString(BugSubmission bug,
        ...
        categoria.setName(CATEGORIA_FIELD_NAME);
